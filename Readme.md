...
This repository uses a deprecated SDK, and newer SDKs are now available. Please visit [this page](https://www.red5.net/live-streaming-sdks/) and [this repository](https://github.com/red5pro/red5pro-ios-testbed) for the latest versions. If you are an existing Red5 customer still using the deprecated SDK, you can continue to use this repository as a reference, but we recommend upgrading to the latest version. [Contact us](https://www.red5.net/contact/) if you have any questions.
